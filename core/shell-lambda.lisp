...
(defpackage :shcl/core/shell-lambda
  ...
  (:export
   #:command-error #:wrap-errors #:shell-lambda #:with-parsed-arguments
   #:handle-command-errors))
(in-package :shcl/core/shell-lambda)
    ...
    `(let ((,name ,command-name))
       (handler-case
         ...
         (command-error (,e)
                        ...
                        (make-instance 'exit-info :exit-status (command-error-return-code ,e)))))))
